...
addCommandHandler("encryptSkins", function(localPlayer)
    ...
    local resource = getResourceFromName("cr_skinpanel");
    resource:stop()    
    ...
    encryptTimer = setTimer(
        function()
            ...
            if child then 
                ...
                local resource = getResourceFromName("cr_skins");
                if resource then
                ...
                local scriptChild = meta:createChild("export");
                scriptChild:setAttribute("function", "isSkinValid");
                scriptChild:setAttribute("type", "shared");   

                local scriptChild = meta:createChild("export");
                scriptChild:setAttribute("function", "isVirtualSkin");
                scriptChild:setAttribute("type", "shared");   
