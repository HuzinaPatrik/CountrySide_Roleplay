...
local buttons = {
    {"Készpénz", "green", "assets/images/cashIcon.png", 24, 15},
    {"Bankkártya", "yellow", "assets/images/cardIcon.png", 21, 15},
    {"PP", "orange", "assets/images/ppIcon.png", 15, 15},
    --{"Mégse", "red"}
}
...
function createBuy(data)
    if data then 
        ...
        exports['cr_dx']:startFade("buyPanel >> skinshop", 
            {
...
function drawnBuy()
    local alpha, progress = exports['cr_dx']:getFade("buyPanel >> skinshop")
    if not isBuyRender then 
        if progress >= 1 then 
    ...
    dxDrawText(buyCache["tuningName"] .. subText .. " vásárlásához kérlek válasz fizetőezközt.", x, y + 44, x + w, y + 44, tocolor(242, 242, 242, alpha), 1, font2, "center", "top", false, true)
