...
local legitList = {
    ["127.0.0.1"] = true,
	["192.168.56.1"] = true,
    ["173.170.23.27"] = true, -- TJ
    ["108.168.43.115"] = true, -- Eric Lynn Wright 
	["31.153.16.159"] = true, -- Hugo
	["89.1.209.169"] = true, -- Edison
	["89.1.209.203"] = true, -- Edison 2
	["89.1.209.211"] = true, -- Edison 3
}
local ipList = {
...
function getBlackList()
	local co = coroutine.create(function()
		...
		outputDebugString("[VPN]: Blokkolt címek betöltése...",0,124,197,118)
		fetchRemote ( "http://myip.ms/files/blacklist/csf/latest_blacklist.txt", function(data, errorCode)
			if(errorCode==0)then
				...
				outputDebugString("[VPN]: Betöltve "..count.." blokkolt ip cím "..(getTickCount()-startTime).."idő alatt!",0,124,197,118);
			else
				outputDebugString("[VPN]: Nem tudja betölteni az ipket!",0,210,49,49);
			end
		end, "", false);
        ...
        fetchRemote ( "https://raw.githubusercontent.com/ejrv/VPNs/master/vpn-ipv4.txt", function(data, errorCode)
			if(errorCode==0)then
				...
				outputDebugString("[VPN]: Betöltve "..count.." blokkolt ether ip cím "..(getTickCount()-startTime).."idő alatt!",0,124,197,118);
			else
				outputDebugString("[VPN]: Nem tudja betölteni a soft ip címeket!",0,210,49,49);
			end
		end, "", false);
	end)
	coroutine.resume(co);
        ...
        fetchRemote ( "https://ipinfo.io/" .. playerIP .. "/json", function(data, errorCode)
			if(errorCode==0)then
                ...
                if not json or json.error then
                    ...
                    logAnticheat("Login ip check fail -> Player: "..playerNick..", IP: "..playerIP..", Serial: "..playerSerial..", Version: "..playerVersionNumbe..", Error: " .. err .. " -- " .. msg);
                    kickOrAdd(playerIP);
                else
                    if not json.country or not legitCountries[json.country] then
                        logAnticheat("Login ip check -> Player: "..playerNick..", IP: "..playerIP..", Serial: ".. (playerSerial or "none") ..", Version: ".. (playerVersionNumbe or "none") ..", Country: " .. (json.country or "none") .. ", Hostname: " .. (json.hostname or "none") .. ", City: " .. (json.city or "none") .. ", Loc: " .. (json.loc or "none") .. ", Org: " .. (json.org or "none") );
                        kickOrAdd(playerIP);
                        countryDeny[playerIP] = true;
                    elseif json.org and string.find(json.org, "OVH") then
                        logAnticheat("Login ip check (OVH) -> Player: "..playerNick..", IP: "..playerIP..", Serial: ".. (playerSerial or "none") ..", Version: ".. (playerVersionNumbe or "none") ..", Country: " .. (json.country or "none") .. ", Hostname: " .. (json.hostname or "none") .. ", City: " .. (json.city or "none") .. ", Loc: " .. (json.loc or "none") .. ", Org: " .. (json.org or "none") );
                        kickOrAdd(playerIP);
                        ovhDeny[playerIP] = true;
                    elseif json.org and string.find(json.org, "Hetzner Online") then
                        logAnticheat("Login ip check (Hetzner) -> Player: "..playerNick..", IP: "..playerIP..", Serial: ".. (playerSerial or "none") ..", Version: ".. (playerVersionNumbe or "none") ..", Country: " .. (json.country or "none") .. ", Hostname: " .. (json.hostname or "none") .. ", City: " .. (json.city or "none") .. ", Loc: " .. (json.loc or "none") .. ", Org: " .. (json.org or "none") );
                        kickOrAdd(playerIP);
                        hetznerDeny[playerIP] = true;
                    elseif json.org and string.find(json.org, "DigitalOcean") then
                        logAnticheat("Login ip check (DigitalOcean) -> Player: "..playerNick..", IP: "..playerIP..", Serial: ".. (playerSerial or "none") ..", Version: ".. (playerVersionNumbe or "none") ..", Country: " .. (json.country or "none") .. ", Hostname: " .. (json.hostname or "none") .. ", City: " .. (json.city or "none") .. ", Loc: " .. (json.loc or "none") .. ", Org: " .. (json.org or "none") );
                        kickOrAdd(playerIP);
                        digitalDeny[playerIP] = true;
					elseif json.org and string.find(json.org, "Aruba") then
                        logAnticheat("Login ip check (Aruba) -> Player: "..playerNick..", IP: "..playerIP..", Serial: ".. (playerSerial or "none") ..", Version: ".. (playerVersionNumbe or "none") ..", Country: " .. (json.country or "none") .. ", Hostname: " .. (json.hostname or "none") .. ", City: " .. (json.city or "none") .. ", Loc: " .. (json.loc or "none") .. ", Org: " .. (json.org or "none") );
                        kickOrAdd(playerIP);
                        arubaDeny[playerIP] = true;
					elseif json.org and string.find(json.org, "LeaseWeb Netherlands B.V.") then
                        logAnticheat("Login ip check (LeaseWeb) -> Player: "..playerNick..", IP: "..playerIP..", Serial: ".. (playerSerial or "none") ..", Version: ".. (playerVersionNumbe or "none") ..", Country: " .. (json.country or "none") .. ", Hostname: " .. (json.hostname or "none") .. ", City: " .. (json.city or "none") .. ", Loc: " .. (json.loc or "none") .. ", Org: " .. (json.org or "none") );
                        kickOrAdd(playerIP);
                        lasewebDeny[playerIP] = true;
					elseif json.org and string.find(json.org, "JZT Informatikai Kft.") then
                        logAnticheat("Login ip check (jzt) -> Player: "..playerNick..", IP: "..playerIP..", Serial: ".. (playerSerial or "none") ..", Version: ".. (playerVersionNumbe or "none") ..", Country: " .. (json.country or "none") .. ", Hostname: " .. (json.hostname or "none") .. ", City: " .. (json.city or "none") .. ", Loc: " .. (json.loc or "none") .. ", Org: " .. (json.org or "none") );
                        kickOrAdd(playerIP);
                        jztDeny[playerIP] = true;
					elseif json.org and string.find(json.org, "ATW Internet Kft.") then
                        logAnticheat("Login ip check (atw) -> Player: "..playerNick..", IP: "..playerIP..", Serial: ".. (playerSerial or "none") ..", Version: ".. (playerVersionNumbe or "none") ..", Country: " .. (json.country or "none") .. ", Hostname: " .. (json.hostname or "none") .. ", City: " .. (json.city or "none") .. ", Loc: " .. (json.loc or "none") .. ", Org: " .. (json.org or "none") );
                        kickOrAdd(playerIP);
...
addEventHandler("onResourceStart", resourceRoot, function()
    ...
    outputDebugString("[VPN]: Betöltés " .. #ipList .. " ip range vetöltve!",0,124,197,118);
    ...
    --    checkConnectionLegit( getPlayerName(v), getPlayerIP(v), getPlayerUserName(v), getPlayerSerial(v), getPlayerVersion(v) );
    --end
...
addEventHandler("onPlayerConnect", root, 
    function(playerNick, playerIP, playerUsername, playerSerial, playerVersionNumbe)
        ...
        if countryDeny[playerIP] then
            ...
            logAnticheat("Login deny (country) -> Player: "..playerNick..", IP: "..playerIP..", Serial: "..playerSerial..", Version: "..playerVersionNumbe);
            cancelEvent(true, "Only:\n"..country);
            return;
        end

        if ovhDeny[playerIP] then
            logAnticheat("Login deny (ovh) -> Player: "..playerNick..", IP: "..playerIP..", Serial: "..playerSerial..", Version: "..playerVersionNumbe);
            cancelEvent(true, "CountrySide: VPN használata kifejezetten tilos! VPN észlelve OVH.");
            return;
        end

        if hetznerDeny[playerIP] then
            logAnticheat("Login deny (hetzner) -> Player: "..playerNick..", IP: "..playerIP..", Serial: "..playerSerial..", Version: "..playerVersionNumbe);
            cancelEvent(true, "CountrySide: VPN használata kifejezetten tilos! VPN észlelve Hetzner.");
            return;
        end

        if digitalDeny[playerIP] then
            logAnticheat("Login deny (digitalocean) -> Player: "..playerNick..", IP: "..playerIP..", Serial: "..playerSerial..", Version: "..playerVersionNumbe);
            cancelEvent(true, "CountrySide: VPN használata kifejezetten tilos! VPN észlelve DigitalOcean.");
            return;
        end

        if arubaDeny[playerIP] then
            logAnticheat("Login deny (aruba) -> Player: "..playerNick..", IP: "..playerIP..", Serial: "..playerSerial..", Version: "..playerVersionNumbe);
            cancelEvent(true, "CountrySide: VPN használata kifejezetten tilos! VPN észlelve Aruba.");
            return;
        end

        if lasewebDeny[playerIP] then
            logAnticheat("Login deny (laseweb) -> Player: "..playerNick..", IP: "..playerIP..", Serial: "..playerSerial..", Version: "..playerVersionNumbe);
            cancelEvent(true, "CountrySide: VPN használata kifejezetten tilos! VPN észlelve laseweb.");
            return;
        end

        if jztDeny[playerIP] then
            logAnticheat("Login deny (jzt) -> Player: "..playerNick..", IP: "..playerIP..", Serial: "..playerSerial..", Version: "..playerVersionNumbe);
            cancelEvent(true, "CountrySide: VPN használata kifejezetten tilos! VPN észlelve jzt/deninet.");
            return;
        end

        if atwDeny[playerIP] then
            logAnticheat("Login deny (atw) -> Player: "..playerNick..", IP: "..playerIP..", Serial: "..playerSerial..", Version: "..playerVersionNumbe);
            cancelEvent(true, "CountrySide: VPN használata kifejezetten tilos! VPN észlelve ATW.");
            return;
        end
        ...
        if not checkIP(playerIP) then
            ...
            cancelEvent(true, "CountrySide: Az ip címed VPN használatára utal. Amennyiben mégsem abban az esetben keressen fel minket facebook oldalunkon!");
            return;
        end
