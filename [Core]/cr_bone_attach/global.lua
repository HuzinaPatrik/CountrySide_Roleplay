...
function attachElementToBone(element, ped, bone, x, y, z, rx, ry, rz)
	...
	if isFromServerSide then
		triggerClientEvent("attachElementToBone", root, element, ped, bone, x, y, z, rx, ry, rz)
	end
...
function detachElementFromBone(element)
	...
	if isFromServerSide then
		triggerClientEvent("detachElementFromBone", root, element)
	end
...
addEventHandler(isFromServerSide and "onElementDestroy" or "onClientElementDestroy", root, forgetDestroyedElements)
