...
addCommandHandler("stat", 
    function()
        if exports['cr_core']:getPlayerDeveloper(localPlayer) then
            colors = {
                ["yellow"] = {exports['cr_core']:getServerColor("yellow", true), exports['cr_core']:getServerColor("yellow")},
                ["red"] = {exports['cr_core']:getServerColor("red", true), exports['cr_core']:getServerColor("red")},
                ["green"] = {exports['cr_core']:getServerColor("green", true), exports['cr_core']:getServerColor("green")},
