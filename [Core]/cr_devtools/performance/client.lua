...
addCommandHandler("performancelog",
	function (command, target)
		if exports['cr_permission']:hasPermission(localPlayer, "performancelog") and not target then
...
addCommandHandler("performance",
	function (command, target)
		if exports['cr_permission']:hasPermission(localPlayer, "performance") and not target then
...
function processRT()
	font = exports['cr_fonts']:getFont('Poppins-SemiBold', 12)
	font2 = exports['cr_fonts']:getFont('Poppins-Medium', 18)
