...
function createPanelForRent()
	local alpha, progress = exports['cr_dx']:getFade("bikeRent")
	...
	dxDrawText("Bicikli bérlés", x + 10 + 26 + 10,y+10,x+w,y+10+30 + 4,tocolor(242, 242, 242, alpha),1,font,"left","center")
	...
	if exports['cr_core']:isInSlot(x + 30, y + 290, 340, 35) then 
		...
		dxDrawText("Bicikli bérlése", x + 30, y + 290, x + 30 + 340, y + 290 + 35 + 4, tocolor(242, 242, 242, alpha), 1, font2, "center", "center")
	else 
		dxDrawRectangle(x + 30, y + 290, 340, 35, tocolor(97, 177, 90, alpha * 0.7))
		dxDrawText("Bicikli bérlése", x + 30, y + 290, x + 30 + 340, y + 290 + 35 + 4, tocolor(242, 242, 242, alpha * 0.6), 1, font2, "center", "center")
	end 
end
			...
			if b == "left" and s == "down" then 
				if hover then 
					...
					elseif hover == "rent" then 
						...
						if not getElementData(localPlayer,"bikeRent >> on_rent") or nil then
							...
							if exports['cr_core']:takeMoney(localPlayer, count_price, false) then
								...
								exports['cr_infobox']:addBox("success", "Sikeresen kibéreltél egy biciklit!")
								triggerServerEvent("bikeRent >> giveRentCar", resourceRoot, localPlayer, vehicle_list[selected_veh][1], rent_time[selectedRentTime].tim, vehicle_list[selected_veh][4])
								exitRentPanel()
							else
								exports['cr_infobox']:addBox("error", "Sajnálom, de nincs elég pénzed a bérléshez!")
							end  			 			
						else
							exports['cr_infobox']:addBox("error", "Ameddig van Biciklived bérelve, nem tudsz újat bérelni!")
						end
					end 
...
function showRentPanel()
	if not panelState then 
		exports['cr_dx']:startFade("bikeRent", 
			{
