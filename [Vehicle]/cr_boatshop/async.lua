--Ami itt van ez alatt ezt mindig használjuk asyncre!

--[[
Kezdetben beállítunk 2 dolgot:
Async:setPriority("high")
Async:setDebug(true)
és ennyi csak használjuk <3
Példa a foreach ciklusra ami jól jön szerveren például:
