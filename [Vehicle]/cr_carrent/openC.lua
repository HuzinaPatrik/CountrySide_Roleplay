...
function createPedChat()
	local alpha, progress = exports['cr_dx']:getFade("carRent.ped")
	...
	local pedMessages = {
		"Üdvözöllek a John&Smith autóbérlőnél. Ha járművet szeretnél bérelni, nyomd meg az ".. green .."'enter' ".. white .."gombot, ha pedig folytatnád az utad tovább, nyomd meg a ".. green .."'backspace' ".. white .."billentyűt!"
	}	
