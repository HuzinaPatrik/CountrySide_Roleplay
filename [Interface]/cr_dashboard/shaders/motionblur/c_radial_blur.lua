...
function enableRadialBlur()
    ...
    radialMaskTexture = dxCreateTexture( "shaders/motionblur/images/radial_mask.tga", "dxt5" )
    radialBlurShader,tecName = dxCreateShader( "shaders/motionblur/fx/radial_blur.fx" )
	...
	addEventHandler("onClientHUDRender", root, drawnMotionBlur, true, "low" .. orderPriority)
end
...
function disableRadialBlur()
	...
	removeEventHandler("onClientHUDRender", root, drawnMotionBlur)
