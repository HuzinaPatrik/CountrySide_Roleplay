...
function startCarPaintRefLite()
	...
	paintShader, tec = dxCreateShader("shaders/carshinereflection/fx/car_paint" .. layerString .. ".fx", 2, v.renderDistance, v.isEffectlayered[1], "vehicle")
	...
	glassShader, tec = dxCreateShader("shaders/carshinereflection/fx/car_glass" .. layerString .. ".fx", 2, v.renderDistance, v.isEffectlayered[2], "vehicle")
	shatterShader, tec = dxCreateShader("shaders/carshinereflection/fx/car_glass" .. layerString .. ".fx", 2, v.renderDistance, v.isEffectlayered[2], "vehicle")

	textureVol = dxCreateTexture("shaders/carshinereflection/images/smallnoise3d.dds")
