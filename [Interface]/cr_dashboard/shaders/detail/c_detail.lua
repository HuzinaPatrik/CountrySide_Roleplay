...
local bEffectEnabled, detail22Texture, detail58Texture, detail68Texture, detail63Texture, detail63Texture, dirtyTexture, detail04Texture, detail29Texture, detail55Texture, detail35TTexture, brickWallShader, grassShader, roadShader, road2Shader, paveDirtyShader, paveStretchShader, barkShader, rockShader, mudShader, concreteShader, sandShader, effectParts, bAllValid, bEffectEnabled

function enableDetail()
	if bEffectEnabled then return end

	-- Load textures
	detail22Texture = dxCreateTexture('shaders/detail/files/detail22.png', "dxt3")
	detail58Texture = dxCreateTexture('shaders/detail/files/detail58.png', "dxt3")
	detail68Texture = dxCreateTexture('shaders/detail/files/detail68.png', "dxt1")
	detail63Texture = dxCreateTexture('shaders/detail/files/detail63.png', "dxt3")
	dirtyTexture = dxCreateTexture('shaders/detail/files/dirty.png', "dxt3")
	detail04Texture = dxCreateTexture('shaders/detail/files/detail04.png', "dxt3")
	detail29Texture = dxCreateTexture('shaders/detail/files/detail29.png', "dxt3")
	detail55Texture = dxCreateTexture('shaders/detail/files/detail55.png', "dxt3")
	detail35TTexture = dxCreateTexture('shaders/detail/files/detail35T.png', "dxt3")
